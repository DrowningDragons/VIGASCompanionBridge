...
#include "VIModularPlayerStateCharacter.h"
...
AVIModularPlayerStateCharacter::AVIModularPlayerStateCharacter(const FObjectInitializer& OI)
	: Super(OI)
{
...
void AVIModularPlayerStateCharacter::BeginPlay()
{
	Super::BeginPlay();
...
void AVIModularPlayerStateCharacter::PossessedBy(AController* NewController)
{
...
void AVIModularPlayerStateCharacter::OnRep_Controller()
{
...
void AVIModularPlayerStateCharacter::CheckJumpInput(float DeltaTime)
{
...
void AVIModularPlayerStateCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME_CONDITION(AVIModularPlayerStateCharacter, bRepIsVaulting, COND_SimulatedOnly);
	DOREPLIFETIME_CONDITION(AVIModularPlayerStateCharacter, RepMotionMatch, COND_SimulatedOnly);
}

void AVIModularPlayerStateCharacter::Jump()
{
...
void AVIModularPlayerStateCharacter::StopJumping()
{
	Super::StopJumping();
...
void AVIModularPlayerStateCharacter::StartVaultAbility_Implementation()
{
	// Called by GA_Vault
...
void AVIModularPlayerStateCharacter::StopVaultAbility()
{
...
void AVIModularPlayerStateCharacter::OnRep_MotionMatch()
{
...
bool AVIModularPlayerStateCharacter::IsVaulting() const
{
...
FVector AVIModularPlayerStateCharacter::GetVaultDirection_Implementation() const
{
...
bool AVIModularPlayerStateCharacter::CanVault_Implementation() const
{
...
void AVIModularPlayerStateCharacter::OnLocalPlayerVault_Implementation(const FVector& Location, const FVector& Direction)
{
...
void AVIModularPlayerStateCharacter::GetVaultLocationAndDirection_Implementation(FVector& OutLocation, FVector& OutDirection) const
{
...
void AVIModularPlayerStateCharacter::ReplicateMotionMatch_Implementation(const FVIRepMotionMatch& MotionMatch)
{
...
bool AVIModularPlayerStateCharacter::IsWalkable_Implementation(const FHitResult& HitResult) const
{
	// Surface we hit can be walked on or not
	return GetCharacterMovement() && GetCharacterMovement()->IsWalkable(HitResult);
}

bool AVIModularPlayerStateCharacter::CanAutoVaultInCustomMovementMode_Implementation() const
{
	return true;
